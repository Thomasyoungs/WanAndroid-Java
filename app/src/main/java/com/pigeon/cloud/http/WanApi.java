...
import com.pigeon.cloud.module.main.model.BetaUserBean;
...
import com.pigeon.cloud.module.main.model.JinrishiciBean;
import com.pigeon.cloud.module.main.model.ListBean;
import com.pigeon.cloud.module.main.model.UpdateBean;
import com.pigeon.cloud.module.main.model.UsefulWebBean;
...
public class WanApi extends Api {
    private static final String HEADER_USER_AGENT =
            "User-Agent: " + Constant.BROWSER_UA;
